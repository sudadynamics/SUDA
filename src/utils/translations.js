export const translations = {
  tr: {
    ...
    navShowcase: "Vitrin",
    showcaseTitle: "Proje Vitrinimiz",
    showcaseSubtitle: "Suda Dynamics ekibi olarak hayata geçirdiğimiz yenilikçi ve yüksek performanslı çözümler.",
    filterAll: "Tümü",
    filterWeb: "Web",
    filterMobile: "Mobil",
    filterAutomation: "Otomasyon",
    filterIntegration: "Entegrasyon",
    adminLoginBtn: "Yönetici Girişi",
    adminLogoutBtn: "Çıkış Yap",
    adminTitle: "Yönetici Girişi",
    adminUsername: "Kullanıcı Adı",
    adminPassword: "Şifre",
    adminLoginSubmit: "Giriş Yap",
    adminAddProject: "Yeni Proje Ekle",
    adminEditProject: "Projeyi Düzenle",
    adminDeleteProject: "Projeyi Sil",
    adminCancel: "İptal",
    adminSave: "Kaydet",
    projectTitleTr: "Proje Adı (Türkçe)",
    projectTitleEn: "Proje Adı (İngilizce)",
    projectDescTr: "Açıklama (Türkçe)",
    projectDescEn: "Açıklama (İngilizce)",
    projectCategory: "Kategori",
    projectTechs: "Teknolojiler (Virgülle ayırın)",
    projectLink: "Proje Linki",
    projectImage: "Görsel URL (İsteğe bağlı)",
  ...
  en: {
    ...
    showcaseTitle: "Our Project Showcase",
    showcaseSubtitle: "Innovative, high-performance solutions brought to life by the Suda Dynamics team.",
    filterAll: "All",
    filterWeb: "Web",
    filterMobile: "Mobile",
    ...
    adminAddProject: "Add New Project",
    adminEditProject: "Edit Project",
    adminDeleteProject: "Delete Project",
    adminCancel: "Cancel",
    adminSave: "Save",
    projectTitleTr: "Project Title (Turkish)",
    projectTitleEn: "Project Title (English)",
    projectDescTr: "Description (Turkish)",
    projectDescEn: "Description (English)",
    projectCategory: "Category",
    projectTechs: "Technologies (Comma separated)",
    projectLink: "Project Link",
    projectImage: "Image URL (Optional)",
